...
INPUT_PATH = DATA_DIR / "동별_25개월평균_방문생활인구수_빠른추정.csv"
OUTPUT_PNG = DATA_DIR / "상위9개동_시간대별_25개월평균_방문생활인구수_barplot.png"
OUTPUT_CSV = DATA_DIR / "상위9개동_시간대별_25개월평균_방문생활인구수.csv"
...
def main() -> None:
    ...
    top9["동표시"] = top9["추정_구"].astype(str) + " " + top9["추정_동"].astype(str)
    ...
    ax.set_title("상위 9개 동 시간대별 25개월 평균 방문생활인구수 (단기체류외국인)", loc="left", fontsize=18.5, weight="bold", color="#111827", pad=20)
